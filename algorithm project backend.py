...
item_list = ["(Pencil", "Pen", "Sharpner", "Eraser", "Markers", "Tape", "Classwiz-Calculator", "Corrector", "Stapler", "Scale",
             "Color-changing-mug", "Acrylic Shield", "Card-keychain", "White-notepad", "World-map-penset", "HU-spiral-Notebook"]
print("Item to for Sale:", item_list)

lst = []


input_string = input(
    'Enter elements of a list separated by space, for double quantity input the item again!: ')
# Enter items like this: Pen Pencil Pencil Sharpner
print("\n")
user_list = input_string.split()
print(user_list)


def list_cart(user_list, inventory):
    total_price = 0
    for item in user_list:
        details = inventory[item]
        details[1] = details[1] - 1
        total_price += details[0]
    # print(inventory) #uncomment to check the decrease in inventory.
    print("total price is: ", total_price)


list_cart(user_list, inventory)
