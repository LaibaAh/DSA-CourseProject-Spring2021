...
# test caseses
# print(getShortestPath(ad_list, "Hu Dukaan", "Cafeteria"))
# print(getShortestPath(ad_list, "Hu Dukaan", "Dhaaba"))
# print(getShortestPath(ad_list, "Hu Dukaan", "Day Care"))
...
def delivery_time(result, Start):
    ...
    if len(result) > 0:
        ...
        print("The Total Delivery Time is: ", delivery_time)
